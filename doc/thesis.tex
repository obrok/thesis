...
\subsection{Ocena uszeregowania zwracanych dokumentów}
\label{sec:ranking}
...
Rozdział zawiera także porównanie czasu działania obydwu metod. Na jego końcu
znajdują się wnioski jakie można wyciągnąć z zebranych danych.
...
\ref{lsi_topics} można interpretować jako ,,nie pogoda i finanse'' ---
...
jak na przykład temat numer 5 w tabeli \ref{lda_topics}, który wydaje się łączyć
